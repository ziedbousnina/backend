...
module.exports = function validateQuoteInput(data) {
  ...
  data.sensors = Array.isArray(data.sensors) ? data.sensors : [];
  data.caracteristique = Array.isArray(data.caracteristique) ? data.caracteristique : [];
  ...
  if (validator.isEmpty(data.disinfection)) {
    errors.disinfection = "Disinfection field is required";
  }
