...
const { CreateBin2, fetchAllBins, updateStatus, FetchBinsNotInPointBin, fetchBinByID, fetchAccessListBinByUser, OpenBinByIDBin, fetchAllPointBinsAndHerBinsByUserId, deleteBin, UpdateBin, FetchBinsNotInPointBinByMunicipal } = require('../controllers/Bin2.controller');
