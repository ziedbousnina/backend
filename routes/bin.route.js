...
const { CreateBin2, fetchAllBins, updateStatus, FetchBinsNotInPointBin, fetchBinByID, fetchAccessListBinByUser, OpenBinByIDBin, fetchAllPointBinsAndHerBinsByUserId } = require('../controllers/Bin2.controller');
