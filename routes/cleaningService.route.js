...
const { AddCleaningService, findSingleCleaningService, findDemandeInProgressMunicipal, findDemandeInProgressAdmin, DeleteRequest, AcceptCleaningRequestMunicipal } = require('../controllers/CleaningService.controller');
...
router.route('/AcceptCleaningRequestMunicipal/:id').put(AcceptCleaningRequestMunicipal)
