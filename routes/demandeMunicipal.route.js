...
const { AddDemandeMunicipal, findDemandeInProgress, findAllDemande, AcceptDemande, findSingleRequest, findMunicipalByID } = require('../controllers/DemandeMunicipal.controller');
...
router.route('/findDemandeById/:municipalID').get( findMunicipalByID)
